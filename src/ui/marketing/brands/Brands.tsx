...
const Brands: React.FC<BrandsProps> = ({
  title = "1000+ Big brands trust us",
  bg = "bg-base-300",
}) => {
  return (
    // mb-24 is section common margin bottom
    <section className={`py-12 ${bg} sm:py-16 lg:py-20`}>
      <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="xl:flex xl:items-center xl:justify-between">
          <h2 className="text-xl font-semibold text-center text-gray-400 xl:text-left font-pj">
            {title}
          </h2>
