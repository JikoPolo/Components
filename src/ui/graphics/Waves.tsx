const Waves = () => {
  return (
    ...
    <div className="relative">
      ...
      {/* element to indicate the scroll down the transform propoerties are there to center prefectly */}
      <div className="absolute w-8 h-8 bg-slate-50 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2"></div>
    </div>
  );
};
